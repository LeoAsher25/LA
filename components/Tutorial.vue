    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          ...
          <a target="_blank" class="button--doc text-green-500 hover:underline"
        ...
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          ...
          <code class="text-sm p-1 rounded border"
            >components/Tutorial.vue</code
          >
          and start coding in
          <code class="text-sm p-1 rounded border">pages/index.vue</code>. Have
          fun!
        </p>
      </div>
